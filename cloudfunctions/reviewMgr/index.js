  ...
  try {
    ...
    if (action === 'myReviews') {
      ...
      try {
        ...
        console.log('我发出的评价查询结果:', {
          res1Count: res1.data.length,
          res2Count: res2.data.length
        })
        ...
        console.log('合并后评价数据:', allItems.length, '条')
    ...
    if (action === 'receivedReviews') {
      ...
      try {
        ...
        console.log('合并后收到的评价数据:', allItems.length, '条')
